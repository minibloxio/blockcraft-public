    ...
    if (!this.cells[`${cellX},${cellY},${cellZ}`]) { // Check if chunk already exists
      ...
      for (let z = 0; z < cellSize; ++z) {
        for (let x = 0; x < cellSize; ++x) {
          ...
          const height = Math.floor((noise.simplex2(xPos/30, zPos/30)+1)*5)+30;
...
const texture = texture_loader.load('./textures/texture-atlas.png');
